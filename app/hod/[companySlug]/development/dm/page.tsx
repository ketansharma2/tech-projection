...
export default function HodDMPage() {
  ...
  useEffect(() => {
    async function loadTasks() {
      if (companySlug) {
        ...
        try {
          const response = await fetch(`/api/hod/tasks?${params.toString()}`)
  ...
  // Stats for UI (based on filtered tasks - changes with tab selection)
  ...
  return (
    <main className="pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <TitleBlock title="Digital Marketing - HOD View" />
