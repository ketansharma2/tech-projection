          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <nav className="flex items-center gap-2">
                ...
                <a href={`/${companySlug}/development`} className="px-3.5 py-2 text-sm font-medium rounded-lg transition-all duration-200"
                  style={{
                    color: theme.primaryColor,
                    backgroundColor: theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.1)' : '#e0e7ff',
                    border: `1px solid ${theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.3)' : '#e0d5ff'}`,
                ...
                <a href={`/${companySlug}/development/data`} className="px-3.5 py-2 text-sm font-medium rounded-lg transition-all duration-200"
                  style={{
                    color: theme.primaryColor,
                    backgroundColor: theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.1)' : '#e0e7ff',
                    border: `1px solid ${theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.3)' : '#e0d5ff'}`,
                ...
                <a href={`/${companySlug}/development/products`} className="px-3.5 py-2 text-sm font-medium rounded-lg transition-all duration-200"
                  style={{
                    color: theme.primaryColor,
                    backgroundColor: theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.1)' : '#e0e7ff',
                    border: `1px solid ${theme.slug === 'profit-pathshala' ? 'rgba(217, 119, 6, 0.3)' : '#e0d5ff'}`,
