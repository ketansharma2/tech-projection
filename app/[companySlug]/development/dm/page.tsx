...
export default function DMPage() {
  ...
  // Use fetched tasks (no dummy data fallback)
  ...
  const filteredTasks = useMemo(() => {
    return tasksSource.filter((task) => {
      ...
      // If deliveryMode is not set, default to In-House behavior
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-gray-500 dark:text-gray-400">
              ...
              <p className="text-sm">There are no tasks assigned to you or matching the current filters.</p>
            </div>
          ) : (
            sections.map((section) => (
